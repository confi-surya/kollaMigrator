...
func init() {
	...
	RootCmd.PersistentFlags().StringVar(&cfgFile, "config", "", "config file (default is $HOME/.migrate-mongo.yaml)")
...
func initConfig() {
	...
	viper.SetConfigName(".migrate-mongo") // name of config file (without extension)
